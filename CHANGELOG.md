...
### Documentation
- All nineteen examples and the Getting Started guide rewritten to match the tone and vocabulary of the reference papers (Stockman 2008, 2019; Stockman & Rider 2023; Stockman & Sharpe; the pycone software instructions). Plain declarative sentences, reasons attached with *since* or *because*, numbers stated flatly, and no dashes or semicolons used as connectors. The invented shape vocabulary is gone: none of *flank*, *dip*, *shoulder*, *limb*, *hump* or *bump* appears anywhere in the reference papers, so sensitivity is now what increases or decreases, at shorter or longer wavelengths or near a stated wavelength. Terms are explained where a reader first meets them.
